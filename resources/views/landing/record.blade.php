...
<section>
   <div class="container mx-auto py-[200px]">
      <div class="flex flex-col justify-center items-center space-y-6 px-4">
         <p class="text-price md:text-pricexl text-text font-bold md:w-1/2 mx-auto text-center">Congratulations your book recorded</p>
         <p class="text-xs md:text-base text-text text-center">Thank You! Your Booking Has Been Successfully Recorded. Get Ready for an Exciting Experience at Taman Kita!</p>
