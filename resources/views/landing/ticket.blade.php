    ...
    <header class="h-[800px]">
        <div class="h-full flex justify-center items-center flex-col"
            ...
            <div class="text-center">
                ...
                <h1 class="text-price md:text-pricexl lg:text-3xl font-bold text-white ">Book<span class="text-primary">
                        Ticket</span></h1>
                <p class="text-white font-normal text-xs  md:text-base mt-8 max-w-[75%] mx-auto">Welcome to the Family Play
                    Zone, Where Adventure and Imagination Unite for Endless Fun and Laughter</p>
            </div>
        </div>
    </header>
